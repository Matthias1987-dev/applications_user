...
Write-Host "Der Ordner $folder wird erstellt./ Greate new folder $folder." -ForegroundColor Green
...
$read = Read-Host "In VSC Ã¶ffnen ? Mit j bestÃ¤tigen!/ Open in VSC? press j."
if ($read -eq "j"){
